...
import io.gresse.hugo.anecdote.anecdote.fragment.WebsiteChooserFragment;
...
public class MainActivity extends AppCompatActivity
    ...
    public void onShareAnecdote(ShareAnecdoteEvent event){
        FabricUtils.trackAnecdoteShare(event.websiteName);
    ...
    public void onCopyAnecdote(CopyAnecdoteEvent event){
        FabricUtils.trackAnecdoteCopy(event.websiteName);
    ...
    public void onOpenAnecdote(OpenAnecdoteEvent event){
        ...
        if (mChromeCustomTabsManager != null) {
            FabricUtils.trackAnecdoteDetails(event.websiteName);
